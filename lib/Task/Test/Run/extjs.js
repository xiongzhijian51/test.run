 ...
 * This class represent a test file, which is supposed to be executed in browser.
 * @author Nickolay (SamuraiJack) Platonov 
 * @version 0.01
 */
 ...
 * @class Test.Run.Harness.Browser
 * This class represent a harness, which is running into browser
 * @singleton
 * @author Nickolay (SamuraiJack) Platonov 
 * @version 0.01
 */
...
/**
 * @property preload The array which contain information about which files should be preloaded into each test's iframe. 
 * @type {String[]} 
 */
